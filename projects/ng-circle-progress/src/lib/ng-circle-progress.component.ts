...
export class CircleProgressComponent implements OnChanges, OnInit, OnDestroy {
 @Output() onClick = new EventEmitter<MouseEvent>();
  ...
  draw = (percent: number) => {
      ...
      if (this.options.titleFormat !== undefined && (this.options.titleFormat as any).constructor.name === 'Function') {
          let formatted = (this.options as any).titleFormat(titlePercent);
      ...
      if (this.options.subtitleFormat !== undefined && (this.options.subtitleFormat as any).constructor.name === 'Function') {
          let formatted = (this.options as any).subtitleFormat(subtitlePercent);
          if (formatted instanceof Array) {
  ...
  private applyOptions = () => {
      ...
      for (let name of Object.keys(this.options)) {
          if (this.hasOwnProperty(name) && (this as any)[name] !== undefined) {
              (this.options as any)[name] = (this as any)[name];
          } else if (this.templateOptions && (this as any).templateOptions[name] !== undefined) {
            (this.options as any)[name] = (this as any).templateOptions[name];
          }
      }
  ...
  public isDrawing(): boolean {
      return (this._timerSubscription && !this._timerSubscription.closed) ?? false;
  }
  ...
  unloadEventsForLazyMode = () => {
      ...
      if (this._viewportChangedSubscriber !== null) {
          ...
          this._viewportChangedSubscriber = undefined;
      }
  }
